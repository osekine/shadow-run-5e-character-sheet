          ...
          SizedBox(
            ...
            child: GestureDetector(
              onDoubleTap: () async {
                int? a = await showDialog(
                    ...
                    builder: (context) => ChangeValueWidget(
                        value: model.fleshWounds, title: 'Flesh Wounds'));
                if (a != null) {
                  model.fleshWounds = a;
                  setState(() {});
                }
              ...
              child: Card(
                ...
                child: Center(
                    child: BigText(
                        text: '${model.fleshWounds}', color: Colors.red)),
              ),
            ),
          ),
          SizedBox(
            ...
            child: GestureDetector(
              onDoubleTap: () async {
                int? a = await showDialog(
                    context: context,
                    builder: (context) => ChangeValueWidget(
                        value: model.stunWounds, title: 'Stun Wounds'));
                if (a != null) {
                  model.stunWounds = a;
                  setState(() {});
                }
              ...
              child: Card(
                ...
                child: Center(
                    child: BigText(
                        text: '${model.stunWounds}', color: Colors.blue)),
              ),
            ),
          ),
        ]);
