              ...
              width: constraints.maxWidth,
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        dataCell(title: 'D', data: attribs?.dataProc.value.toString() ?? '-', flex: 1),
                        dataCell(title: 'F', data: attribs?.firewall.value.toString() ?? '-', flex: 1),
                        dataCell(title: 'A', data: attribs?.attack.value.toString() ?? '-', flex: 1),
                        dataCell(title: 'S', data: attribs?.sleaze.value.toString() ?? '-', flex: 1),
                      ],
                    ),
